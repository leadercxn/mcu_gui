...
#if !defined (FT32F030) && !defined (FT32F072)  && \
    !defined (FT32F072x8) && !defined (FT32F030x6)&& !defined (FT32F030x8)
 #error "Please select first the target FT32F030X8 device used in your application (in ft32f030x8.h file)"
...
/**
 * @brief FT32F030X8 Standard Peripheral Library version number V1.4.0
   */
#define __FT32F030X8_STDPERIPH_VERSION_MAIN   (0x01) /*!< [31:24] main version */
#define __FT32F030X8_STDPERIPH_VERSION_SUB1   (0x05) /*!< [23:16] sub1 version */
#define __FT32F030X8_STDPERIPH_VERSION_SUB2   (0x00) /*!< [15:8]  sub2 version */
#define __FT32F030X8_STDPERIPH_VERSION_RC     (0x00) /*!< [7:0]  release candidate */ 
#define __FT32F030X8_STDPERIPH_VERSION        ((__FT32F030X8_STDPERIPH_VERSION_MAIN << 24)\
                                             |(__FT32F030X8_STDPERIPH_VERSION_SUB1 << 16)\
                                             |(__FT32F030X8_STDPERIPH_VERSION_SUB2 << 8)\
                                             |(__FT32F030X8_STDPERIPH_VERSION_RC))
...
/*******************  Bit definition for OP_CR register  ********************/
#define	OP_CR_OP0ON													 ((uint32_t)0x00000001)
#define	OP_CR_OP0COF												 ((uint32_t)0x0000003E)
#define	OP_CR_OP0COF_0											 ((uint32_t)0x00000002)
#define	OP_CR_OP0COF_1											 ((uint32_t)0x00000004)
#define	OP_CR_OP0COF_2											 ((uint32_t)0x00000008)
#define	OP_CR_OP0COF_3											 ((uint32_t)0x00000010)
#define	OP_CR_OP0COF_4											 ((uint32_t)0x00000020)
#define	OP_CR_OPTOIO  											 ((uint32_t)0x00000040)
#define	OP_CR_OPTODIG  											 ((uint32_t)0x00000080)
#define	OP_CR_OP0TM    											 ((uint32_t)0x00000100)
#define	OP_CR_OP0FCAPE 											 ((uint32_t)0x00000200)
#define	OP_CR_OP0FR   											 ((uint32_t)0x00001C00)
#define	OP_CR_OP0FR_0   										 ((uint32_t)0x00000400)
#define	OP_CR_OP0FR_1 											 ((uint32_t)0x00000800)
#define	OP_CR_OP0FR_2   										 ((uint32_t)0x00001000)
#define	OP_CR_OP0NSEL  											 ((uint32_t)0x00006000)
#define	OP_CR_OP0NSEL_0											 ((uint32_t)0x00002000)
#define	OP_CR_OP0NSEL_1											 ((uint32_t)0x00004000)
#define	OP_CR_OP0PSEL   										 ((uint32_t)0x00008000)
#define	OP_CR_OP0OUT    										 ((uint32_t)0x00010000)
