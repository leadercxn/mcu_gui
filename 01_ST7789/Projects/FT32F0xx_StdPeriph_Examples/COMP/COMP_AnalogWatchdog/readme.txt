...
This example shows how to make an analog watchdog using the FT32f0xx COMPs 
peripherals in window mode:
  - The upper threshold is set to  = 1.875V
  - The lower threshold is set to = 0.468V
  - PB12 as COMP analog input
