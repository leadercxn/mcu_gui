...
#define TIMx_DMA_CHANNEL                 TIM_DMA_CC4

#define TIMx_TRIGGER_PIN                 GPIO_Pin_1
#define TIMx_TRIGGER_GPIO_PORT           GPIOB
#define TIMx_TRIGGER_GPIO_CLK            RCC_AHBPeriph_GPIOB
#define TIMx_TRIGGER_SOURCE              GPIO_PinSource1
#define TIMx_TRIGGER_AF                  GPIO_AF_1
#define TIMx_CHANNEL_INIT                TIM_OC4Init
