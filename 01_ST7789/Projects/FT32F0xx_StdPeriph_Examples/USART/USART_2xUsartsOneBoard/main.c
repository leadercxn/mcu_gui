   /**
  ******************************************************************************
  * @file    USART/USART_2xUsartsOneBoard/main.c 
  * @author  AE
  * @version V1.0.0
  * @date    29-MAR-2021
...
uint8_t aTxBuffer[BUFFER_SIZE] = "USART Example: 2xUsarts Tx/Rx Communication";
uint8_t aRxBuffer[USART_MAX_INDEX][BUFFER_SIZE];
/* Buffer used for reception */
USART_InitTypeDef USART_InitStructure;
__IO uint8_t TxCounter = 0;
extern __IO uint8_t ReceiveState;
USART_TypeDef* UsartInstance[USART_MAX_INDEX] = {USART1, USART2};
...
int main(void)
{
  ...
  */ 
  ...
  /* 2xUSARTs configuration --------------------------------------------------*/
  /* 2xUSARTs  configured as follow:
  - BaudRate = 9600 baud  
  - Word Length = 8 Bits
  - One Stop Bit
  - No parity
