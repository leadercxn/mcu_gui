/**
  ...
  *          definitions and memory mapping for ft32f0xx devices.  
  *          
...
#if !defined (FT32F030) && !defined (FT32F031) && !defined (FT32F051) && \
    !defined (FT32F072) && !defined (FT32F042) && !defined (FT32F091) && \
    !defined (FT32F070xB) && !defined (FT32F070x6) && !defined (FT32F030xC)
 #error "Please select first the target ft32f0xx device used in your application (in ft32f0xx.h file)"
#endif /* FT32F030 || FT32F031 || FT32F051 || FT32F072 || FT32F042 || FT32F091 ||
          FT32F070xB || FT32F070x6 || FT32F030xC */
...
/**
 * @brief FT32F0XX Interrupt Number Definition, according to the selected device 
 *        in @ref Library_configuration_section 
 */
#define __CM0_REV                 0 /*!< Core Revision r0p0                            */
#define __MPU_PRESENT             0 /*!< FT32F0XX do not provide MPU                  */
#define __NVIC_PRIO_BITS          2 /*!< FT32F0XX uses 2 Bits for the Priority Levels */
...
#define	COMP_CSR_NCOMP1EN							 ((uint32_t)0x00000001) /*!< MCOMP enable */
#define	COMP_CSR_NCOMPVIPSEL					 ((uint32_t)0x0000000e) /*!<  */
#define	COMP_CSR_NCOMPVIPSEL_0				 ((uint32_t)0x00000002) /*!<  */
#define	COMP_CSR_NCOMPVIPSEL_1				 ((uint32_t)0x00000004) /*!<  */
#define	COMP_CSR_NCOMPVIPSEL_2				 ((uint32_t)0x00000008) /*!<  */
#define	COMP_CSR_NCOMPVINSEL					 ((uint32_t)0x00000030) /*!<  */
#define	COMP_CSR_NCOMPVINSEL_0				 ((uint32_t)0x00000010) /*!<  */
#define	COMP_CSR_NCOMPVINSEL_1				 ((uint32_t)0x00000020) /*!<  */
...
#define	COMP_CSR_NCOMPPOL							 ((uint32_t)0x00000800) /*!<  */
#define	COMP_CSR_COMP1OUT							 ((uint32_t)0x00004000) /*!<  */
#define	COMP_CSR_NCOMPLOCK						 ((uint32_t)0x00008000) /*!<  */

/* PCOMP bits definition */
#define	COMP_CSR_PCOMP1EN							 ((uint32_t)0x00010000) /*!< PCOMP enable */
#define	COMP_CSR_PCOMPVIPSEL					 ((uint32_t)0x00060000) /*!<  */
#define	COMP_CSR_PCOMPVIPSEL_0				 ((uint32_t)0x00020000) /*!<  */
#define	COMP_CSR_PCOMPVIPSEL_1				 ((uint32_t)0x00040000) /*!<  */
#define	COMP_CSR_PCOMPVINSEL					 ((uint32_t)0x00180000) /*!<  */
#define	COMP_CSR_PCOMPVINSEL_0				 ((uint32_t)0x00080000) /*!<  */
#define	COMP_CSR_PCOMPVINSEL_1				 ((uint32_t)0x00100000) /*!<  */
#define	COMP_CSR_WNDWEN								 ((uint32_t)0x00800000) /*!<  */

#define	COMP_CSR_COMP2OUTSEL					 ((uint32_t)0x07000000) /*!<  */
#define	COMP_CSR_COMP2OUTSEL_0				 ((uint32_t)0x01000100) /*!<  */
#define	COMP_CSR_COMP2OUTSEL_1				 ((uint32_t)0x02000200) /*!<  */
#define	COMP_CSR_COMP2OUTSEL_2				 ((uint32_t)0x04000400) /*!<  */
#define	COMP_CSR_PCOMPPOL							 ((uint32_t)0x08000000) /*!<  */
#define	COMP_CSR_COMP2OUT							 ((uint32_t)0x40000000) /*!<  */
#define	COMP_CSR_PCOMPLOCK						 ((uint32_t)0x80000000) /*!<  */
...
#define  CRC_CR_POLSIZE                      ((uint32_t)0x00000018) /*!< Polynomial size bits (FT32F0XX do not provide)*/
#define  CRC_CR_POLSIZE_0                    ((uint32_t)0x00000008) /*!< Polynomial size bit 0 (FT32F0XX do not provide) */
#define  CRC_CR_POLSIZE_1                    ((uint32_t)0x00000010) /*!< Polynomial size bit 1 (FT32F0XX do not provide) */
...
#define  CRC_POL_POL                         ((uint32_t)0xFFFFFFFF) /*!< Coefficients of the polynomial (FT32F0XX do not provide) */

/******************************************************************************/
/*                                                                            */
/*                          CRS Clock Recovery System                         */
/*                      (IS Available for FT32F0xx devices)                */
/******************************************************************************/
...
#define  DBGMCU_APB1_FZ_DBG_TIM7_STOP        ((uint32_t)0x00000020)        /*!< TIM7 counter stopped when core is halted (FT32F0XX do not provide) */
...
#define  DBGMCU_APB1_FZ_DBG_CAN_STOP         ((uint32_t)0x02000000)        /*!< CAN debug stopped when Core is halted (FT32F0XX do not provide) */
...
#define  DMA_ISR_GIF6                        ((uint32_t)0x00100000)        /*!< Channel 6 Global interrupt flag (FT32F0XX do not provide) */
#define  DMA_ISR_TCIF6                       ((uint32_t)0x00200000)        /*!< Channel 6 Transfer Complete flag (FT32F0XX do not provide) */
#define  DMA_ISR_HTIF6                       ((uint32_t)0x00400000)        /*!< Channel 6 Half Transfer flag (FT32F0XX do not provide) */
#define  DMA_ISR_TEIF6                       ((uint32_t)0x00800000)        /*!< Channel 6 Transfer Error flag (FT32F0XX do not provide) */
#define  DMA_ISR_GIF7                        ((uint32_t)0x01000000)        /*!< Channel 7 Global interrupt flag (FT32F0XX do not provide) */
#define  DMA_ISR_TCIF7                       ((uint32_t)0x02000000)        /*!< Channel 7 Transfer Complete flag (FT32F0XX do not provides) */
#define  DMA_ISR_HTIF7                       ((uint32_t)0x04000000)        /*!< Channel 7 Half Transfer flag (FT32F0XX do not provide) */
#define  DMA_ISR_TEIF7                       ((uint32_t)0x08000000)        /*!< Channel 7 Transfer Error flag (FT32F0XX do not provide) */
...
#define  DMA_IFCR_CGIF6                      ((uint32_t)0x00100000)        /*!< Channel 6 Global interrupt clear (FT32F0XX do not provide) */
#define  DMA_IFCR_CTCIF6                     ((uint32_t)0x00200000)        /*!< Channel 6 Transfer Complete clear (FT32F0XX do not provide) */
#define  DMA_IFCR_CHTIF6                     ((uint32_t)0x00400000)        /*!< Channel 6 Half Transfer clear (FT32F0XX do not provide) */
#define  DMA_IFCR_CTEIF6                     ((uint32_t)0x00800000)        /*!< Channel 6 Transfer Error clear (FT32F0XX do not provide) */
#define  DMA_IFCR_CGIF7                      ((uint32_t)0x01000000)        /*!< Channel 7 Global interrupt clear (FT32F0XX do not provide) */
#define  DMA_IFCR_CTCIF7                     ((uint32_t)0x02000000)        /*!< Channel 7 Transfer Complete clear (FT32F0XX do not provide) */
#define  DMA_IFCR_CHTIF7                     ((uint32_t)0x04000000)        /*!< Channel 7 Half Transfer clear (FT32F0XX do not provide) */
#define  DMA_IFCR_CTEIF7                     ((uint32_t)0x08000000)        /*!< Channel 7 Transfer Error clear (FT32F0XX do not provide) */
...
#define  RCC_CFGR_PLLSRC_0                   ((uint32_t)0x00008000)        /*!< Bit 0  */
...
#define  RCC_CFGR_PLLSRC_HSE_PREDIV          ((uint32_t)0x00010000)        /*!< HSE PREDIV clock selected as PLL entry clock source (FT32F0XX do not provide)*/	
#define  RCC_CFGR_PLLSRC_HSI48_PREDIV        ((uint32_t)0x00018000)        /*!< HSI48 PREDIV clock selected as PLL entry clock source (FT32F0XX do not provide)*/
...
#define SYSCFG_CFGR1_TIM16_DMA_RMP2         ((uint32_t)0x00002000) /*!< Timer 16 DMA remap 2 (only for FT32F030X8) */
#define SYSCFG_CFGR1_TIM17_DMA_RMP2         ((uint32_t)0x00004000) /*!< Timer 17 DMA remap 2 (only for FT32F030X8) */
...
#define SYSCFG_CFGR1_I2C_FMP_I2C1           ((uint32_t)0x00100000) /*!< Enable Fast Mode Plus on PB10, PB11, PF6 and PF7(only for FT32F030X8 devices) */
#define SYSCFG_CFGR1_I2C_FMP_I2C2           ((uint32_t)0x00200000) /*!< Enable I2C2 Fast mode plus (only for FT32F030X8) */
#define SYSCFG_CFGR1_I2C_FMP_PA9            ((uint32_t)0x00400000) /*!< Enable Fast Mode Plus on PA9 (only for FT32F030X8devices) */
#define SYSCFG_CFGR1_I2C_FMP_PA10           ((uint32_t)0x00800000) /*!< Enable Fast Mode Plus on PA10(only for FT32F030X8devices) */
#define SYSCFG_CFGR1_SPI2_DMA_RMP           ((uint32_t)0x01000000) /*!< SPI2 DMA remap (only for FT32F030X8) */
#define SYSCFG_CFGR1_USART2_DMA_RMP         ((uint32_t)0x02000000) /*!< USART2 DMA remap (only for FT32F030X8) */
#define SYSCFG_CFGR1_USART3_DMA_RMP         ((uint32_t)0x04000000) /*!< USART3 DMA remap (only for FT32F030X8) */
#define SYSCFG_CFGR1_I2C1_DMA_RMP           ((uint32_t)0x08000000) /*!< I2C1 DMA remap (only for FT32F030X8) */
#define SYSCFG_CFGR1_TIM1_DMA_RMP           ((uint32_t)0x10000000) /*!< TIM1 DMA remap (only for FT32F030X8) */
#define SYSCFG_CFGR1_TIM2_DMA_RMP           ((uint32_t)0x20000000) /*!< TIM2 DMA remap (only for FT32F030X8) */
#define SYSCFG_CFGR1_TIM3_DMA_RMP           ((uint32_t)0x40000000) /*!< TIM3 DMA remap (only for FT32F030X8) */
